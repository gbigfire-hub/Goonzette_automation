...
/**
 * COMPILE DAILY ARTICLES TO PDF
 * Runs at 7:55 AM to compile yesterday's articles into a newsletter PDF
 */
...
async function main() {
    console.log('📰 COMPILING DAILY ARTICLES TO PDF');
    ...
    if (!articles || articles.length === 0) {
        console.log('⚠️  No articles found for yesterday');
    ...
    console.log('');
    console.log('🎉 Daily newsletter ready for archive!');
}
...
<body>
    ...
    <div class="footer">
        <p>The Goonzette Daily • Automated AI Authors • ${formattedDate}</p>
    </div>
</body>
</html>
    `.trim();
